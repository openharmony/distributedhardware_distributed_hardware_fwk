...
#include "component_manager_extra_test.h"
...
#undef DH_LOG_TAG
#define DH_LOG_TAG "ComponentManagerExtraTest"
...
void ComponentManagerExtraTest::SetUpTestCase(void)
{
...
void ComponentManagerExtraTest::TearDownTestCase(void)
{
...
void ComponentManagerExtraTest::SetUp()
{
...
void ComponentManagerExtraTest::TearDown()
{
    ComponentManager::GetInstance().compSource_.clear();
    ComponentManager::GetInstance().compSink_.clear();
}
...
void ComponentManagerExtraTest::TestGetDistributedHardwareCallback::OnSuccess(
...
void ComponentManagerExtraTest::TestGetDistributedHardwareCallback::OnError(
 ...
 */
HWTEST_F(ComponentManagerExtraTest, init_test_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSK5
 */
HWTEST_F(ComponentManagerExtraTest, init_test_002, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSK5
 */
HWTEST_F(ComponentManagerExtraTest, unInit_test_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(ComponentManagerExtraTest, init_compSource_test_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSK9
 */
HWTEST_F(ComponentManagerExtraTest, init_compSink_test_001, TestSize.Level1)
{
    ComponentLoader::GetInstance().Init();
    ComponentManager::GetInstance().compSink_.clear();
    SetUpComponentLoaderConfig();
 ...
 * @tc.require: AR000GHSK9
 */
HWTEST_F(ComponentManagerExtraTest, get_enableparam_test_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSK9
 */
HWTEST_F(ComponentManagerExtraTest, get_sinkversion_fromvermgr_test_001, TestSize.Level1)
{
    CompVersion compVersions1 = {
        .name = NAME_CAMERA,
        .dhType = DHType::CAMERA,
 ...
 * @tc.require: AR000GHSK9
 */
HWTEST_F(ComponentManagerExtraTest, GetDHType_test_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(ComponentManagerExtraTest, UnInit_001, TestSize.Level1)
{
    ComponentManager::GetInstance().compMonitorPtr_ = nullptr;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, StartSource_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, StartSource_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, StartSink_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, StopSource_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, StopSink_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSink *sinkPtr = nullptr;
    ComponentManager::GetInstance().compSink_.insert(std::make_pair(dhType, sinkPtr));
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, WaitForResult_001, TestSize.Level1)
{
     ...
     * @tc.require: AR000GHSJM
     */
    HWTEST_F(ComponentManagerExtraTest, InitCompSource_001, TestSize.Level1)
    {
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, InitCompSink_001, TestSize.Level1)
{
    SetUpComponentLoaderConfig();
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, Enable_001, TestSize.Level1)
{
    ComponentManager::GetInstance().compSource_.clear();
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, Enable_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, Disable_001, TestSize.Level1)
{
    ComponentManager::GetInstance().compSource_.clear();
    std::string networkId;
    std::string uuid;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, Disable_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
...
HWTEST_F(ComponentManagerExtraTest, Disable_003, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetDHType_001, TestSize.Level1)
{
    std::string uuid;
    std::string dhId;
    auto ret = ComponentManager::GetInstance().GetDHType(uuid, dhId);
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetDHType_002, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetEnableCapParam_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
...
HWTEST_F(ComponentManagerExtraTest, GetEnableCapParam_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
    std::shared_ptr<CapabilityInfo> capability = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, GetEnableMetaParam_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
...
HWTEST_F(ComponentManagerExtraTest, GetEnableMetaParam_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
    std::shared_ptr<MetaCapabilityInfo> metaCapPtr = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, GetCapParam_001, TestSize.Level1)
{
    std::shared_ptr<CapabilityInfo> capability = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, GetCapParam_002, TestSize.Level1)
{
    std::shared_ptr<CapabilityInfo> capability = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, GetMetaParam_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetMetaParam_002, TestSize.Level1)
{
    std::shared_ptr<MetaCapabilityInfo> metaCapInfo = nullptr;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetEnableParam_001, TestSize.Level1)
{
    std::string networkId;
    std::string uuid;
    std::string dhId;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetEnableParam_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
    CapabilityInfoManager::GetInstance()->globalCapInfoMap_.clear();
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersionFromVerMgr_001, TestSize.Level1)
{
    std::string uuid;
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersionFromVerMgr_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersionFromVerMgr_003, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    DHVersion dhVersion;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersionFromVerInfoMgr_001, TestSize.Level1)
{
    std::string uuid;
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersionFromVerInfoMgr_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, GetVersion_001, TestSize.Level1)
{
    std::string uuid;
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
...
HWTEST_F(ComponentManagerExtraTest, GetVersion_002, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetVersion_003, TestSize.Level1)
{
    std::string uuid = "123456798";
    DHType dhType = DHType::CAMERA;
    std::string sinkVersion;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, UpdateVersionCache_001, TestSize.Level1)
{
    std::string uuid;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, DumpLoadedCompsource_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, DumpLoadedCompsink_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, Recover_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, DoRecover_001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, DoRecover_002, TestSize.Level1)
{
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, RetryGetEnableParam_001, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    EnableParam param;
 ...
 * @tc.require: AR000GHSJM
 */
HWTEST_F(ComponentManagerExtraTest, IsIdenticalAccount_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, OnUnregisterResult_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, OnRegisterResult_001, TestSize.Level1)
{
    std::string networkId = "networkId_test";
    std::string dhId = "dhId_test";
    int32_t status = DH_FWK_SUCCESS;
...
HWTEST_F(ComponentManagerExtraTest, UpdateBusinessState_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, UpdateBusinessState_002, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, UpdateBusinessState_003, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetDHSubtypeByDHId_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetDHSubtypeByDHId_002, TestSize.Level1)
{
    std::string dhid = "audio_1";
    DHSubtype dhSubtype;
    std::string deviceId = Sha256(UUID_TEST);
...
HWTEST_F(ComponentManagerExtraTest, GetDHSubtypeByDHId_003, TestSize.Level1)
{
    std::string dhid = "audio_1";
    DHSubtype dhSubtype;
...
HWTEST_F(ComponentManagerExtraTest, GetDHSubtypeByDHId_004, TestSize.Level1)
{
    std::string dhid = "audio_1";
    DHSubtype dhSubtype;
    std::string networkId = "networkId_123";
...
HWTEST_F(ComponentManagerExtraTest, InitAVSyncSharedMemory_001, TestSize.Level1)
{
    auto ret = ComponentManager::GetInstance().InitAVSyncSharedMemory();
    EXPECT_EQ(ret, DH_FWK_SUCCESS);
}

HWTEST_F(ComponentManagerExtraTest, DeinitAVSyncSharedMemory_001, TestSize.Level1)
{
    ASSERT_NO_FATAL_FAILURE(ComponentManager::GetInstance().DeinitAVSyncSharedMemory());
}

HWTEST_F(ComponentManagerExtraTest, GetDHIdByDHSubtype_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, HandleIdleStateChange_001, TestSize.Level1)
{
    std::string networkId = "";
    std::string dhId = "";
...
HWTEST_F(ComponentManagerExtraTest, HandleBusinessStateChange_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, HandleBusinessStateChange_002, TestSize.Level1)
{
    std::string networkId = "networkId_1";
    std::string dhid = "audio_132";
    DHSubtype dhSubType = DHSubtype::AUDIO_MIC;
...
HWTEST_F(ComponentManagerExtraTest, HandleBusinessStateChange_003, TestSize.Level1)
{
    std::string networkId = "networkId_1";
    std::string dhid = "audio_132";
    DHSubtype dhSubType = DHSubtype::AUDIO_MIC;
...
HWTEST_F(ComponentManagerExtraTest, HandleBusinessStateChange_004, TestSize.Level1)
{
    std::string networkId = "networkId_1";
    std::string dhid = "audio_132";
    DHSubtype dhSubType = DHSubtype::AUDIO_MIC;
...
HWTEST_F(ComponentManagerExtraTest, HandleBusinessStateChange_005, TestSize.Level1)
{
    std::string networkId = "networkId_1";
...
HWTEST_F(ComponentManagerExtraTest, QueryBusinessState_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, QueryBusinessState_002, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, TriggerFullCapsSync_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetDHSourceInstance_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, GetDHSourceInstance_002, TestSize.Level1)
{
    DHType dhType = DHType::CAMERA;
    IDistributedHardwareSource *sourcePtr = nullptr;
    ComponentManager::GetInstance().compSource_.insert(std::make_pair(dhType, sourcePtr));
...
HWTEST_F(ComponentManagerExtraTest, CheckDemandStart_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, RegisterDHStatusListener_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, RegisterDHStatusListener_002, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, UnregisterDHStatusListener_001, TestSize.Level1)
{
    sptr<IHDSinkStatusListener> listener = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, UnregisterDHStatusListener_002, TestSize.Level1)
{
    sptr<IHDSourceStatusListener> listener = nullptr;
...
HWTEST_F(ComponentManagerExtraTest, EnableSink_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, DisableSink_001, TestSize.Level1)
{
    DHDescriptor dhDescriptor {
        .id = AUDIO_ID_TEST,
        .dhType = DHType::AUDIO
...
HWTEST_F(ComponentManagerExtraTest, EnableSource_001, TestSize.Level1)
{
    DHDescriptor dhDescriptor {
        .id = AUDIO_ID_TEST,
        .dhType = DHType::AUDIO
...
HWTEST_F(ComponentManagerExtraTest, DisableSource_001, TestSize.Level1)
{
    DHDescriptor dhDescriptor {
        .id = AUDIO_ID_TEST,
        .dhType = DHType::AUDIO
...
HWTEST_F(ComponentManagerExtraTest, ForceDisableSink_001, TestSize.Level1)
{
    DHDescriptor dhDescriptor {
        .id = AUDIO_ID_TEST,
        .dhType = DHType::AUDIO
...
HWTEST_F(ComponentManagerExtraTest, ForceDisableSource_001, TestSize.Level1)
{
    DHDescriptor dhDescriptor {
        .id = AUDIO_ID_TEST,
        .dhType = DHType::AUDIO
...
HWTEST_F(ComponentManagerExtraTest, UninitCompSource_001, TestSize.Level1)
{
    SetUpComponentLoaderConfig();
...
HWTEST_F(ComponentManagerExtraTest, UninitCompSink_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, UninitCompSink_002, TestSize.Level1)
{
    ComponentLoader::GetInstance().compHandlerMap_.clear();
    SetUpComponentLoaderConfig();
    auto ret = ComponentManager::GetInstance().UninitCompSink(DHType::AUDIO);
...
HWTEST_F(ComponentManagerExtraTest, OnDataSyncTrigger_001, testing::ext::TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, OnStateChanged_001, testing::ext::TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, CheckSinkConfigStart_001, TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, InitAndUnInit_DHCommTool_001, TestSize.Level0)
{
...
HWTEST_F(ComponentManagerExtraTest, SyncRemoteDeviceInfoBySoftbus_001, TestSize.Level0)
{
...
HWTEST_F(ComponentManagerExtraTest, OnGetDescriptors_001, TestSize.Level0)
{
    std::string realNetworkId = "realNetworkId_1";
...
HWTEST_F(ComponentManagerExtraTest, OnGetDescriptors_002, TestSize.Level0)
{
    std::string realNetworkId = "realNetworkId_1";
    EnableStep enableStep = EnableStep::ENABLE_SOURCE;
    std::vector<DHDescriptor> descriptors;
...
HWTEST_F(ComponentManagerExtraTest, OnGetDescriptorsError_001, TestSize.Level0)
{
    std::string realNetworkId = "realNetworkId_1";
    EnableStep enableStep = EnableStep::ENABLE_SOURCE;
    ComponentManager::GetInstance().syncDeviceInfoMap_[realNetworkId] = {enableStep, nullptr};
...
HWTEST_F(ComponentManagerExtraTest, OnStateChanged_Sink_001, testing::ext::TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, SetAVSyncScene_001, testing::ext::TestSize.Level1)
{
...
HWTEST_F(ComponentManagerExtraTest, UpdateSinkBusinessState_001, testing::ext::TestSize.Level1)
{
    std::string networkId = "";
    std::string dhId = "";
    BusinessSinkState state = BusinessSinkState::UNKNOWN;
...
HWTEST_F(ComponentManagerExtraTest, NotifyBusinessStateChange_001, testing::ext::TestSize.Level1)
{
    BusinessState state = BusinessState::UNKNOWN;
    DHSubtype dhSubType = DHSubtype::CAMERA;
