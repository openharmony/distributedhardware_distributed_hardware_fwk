...
#ifndef TEST_CAPABILITYINFOMANAGERTHREE_FUZZER_H
#define TEST_CAPABILITYINFOMANAGERTHREE_FUZZER_H

#define FUZZ_PROJECT_NAME "capabilityinfomanagerthree_fuzzer"
