...
#ifndef OHOS_AV_PIPELINE_HEAD_FILTER_DEMO_H
#define OHOS_AV_PIPELINE_HEAD_FILTER_DEMO_H
...
class HeadFilter : public Filter, public std::enable_shared_from_this<HeadFilter> {
public:
    HeadFilter(std::string name, FilterType type, bool asyncMode = false);
    virtual ~HeadFilter();
...
#endif // OHOS_AV_PIPELINE_HEAD_FILTER_DEMO_H
