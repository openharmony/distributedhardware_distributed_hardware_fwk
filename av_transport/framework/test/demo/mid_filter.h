...
#ifndef OHOS_AV_PIPELINE_MID_FILTER_DEMO_H
#define OHOS_AV_PIPELINE_MID_FILTER_DEMO_H
...
class MidFilter : public Filter, public std::enable_shared_from_this<MidFilter> {
public:
    MidFilter(std::string name, FilterType type, bool asyncMode = false);
    virtual ~MidFilter();
...
#endif // OHOS_AV_PIPELINE_MID_FILTER_DEMO_H
