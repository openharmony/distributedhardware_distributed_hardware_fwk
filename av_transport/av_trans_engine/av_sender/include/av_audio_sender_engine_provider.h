...
#ifndef OHOS_AV_AUDIO_SENDER_ENGINE_PROVIDER_H
#define OHOS_AV_AUDIO_SENDER_ENGINE_PROVIDER_H
...
class AVAudioSenderEngineProvider : public IAVEngineProvider, public ISoftbusChannelListener {
public:
    AVAudioSenderEngineProvider(const std::string ownerName);
    ~AVAudioSenderEngineProvider() override;
...
#endif // OHOS_AV_AUDIO_SENDER_ENGINE_PROVIDER_H