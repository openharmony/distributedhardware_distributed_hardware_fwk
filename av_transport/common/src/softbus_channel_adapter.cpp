...
const static std::pair<std::string, std::string> LOCAL_TO_PEER_SESSION_NAME_MAP[] = {
    {std::string(OWNER_NAME_D_MIC) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_MIC) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_MIC) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_MIC) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SPEAKER) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SPEAKER) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SPEAKER) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SPEAKER) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SCREEN) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SCREEN) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SCREEN) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SCREEN) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + RECEIVER_CONTROL_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + SENDER_CONTROL_SESSION_NAME_SUFFIX},
    ...
    {std::string(OWNER_NAME_D_MIC) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_MIC) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_MIC) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_MIC) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SPEAKER) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SPEAKER) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SPEAKER) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SPEAKER) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SCREEN) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SCREEN) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_SCREEN) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_SCREEN) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_MIC) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX},
    {std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + RECEIVER_DATA_SESSION_NAME_SUFFIX,
     std::string(OWNER_NAME_D_VIRMODEM_SPEAKER) + "_" + SENDER_DATA_SESSION_NAME_SUFFIX},
};
